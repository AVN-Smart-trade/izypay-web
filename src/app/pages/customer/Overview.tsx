    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <span className="hidden sm:flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-full"
          ...
          <Sparkles className="w-3 h-3" /> Tue, 11 Mar 2026
        </span>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between mb-5">
            ...
            <span className="text-[10px] font-bold px-2 py-1 rounded-full" style={{ background: 'rgba(199,162,70,0.12)', color: '#C7A246' }}>2 Active</span>
          </div>
            ...
            {zimbabweTransactions.filter(t => t.escrow).slice(0, 2).map((txn) => (
              <div key={txn.id} className="border border-gray-100 rounded-xl p-4 space-y-3 hover:border-gray-200 transition-colors">
                ...
                <div className="flex gap-2">
                  <Button size="sm" className="flex-1 rounded-xl text-xs font-bold" style={{ background: '#0F6F5C' }}>Confirm Delivery</Button>
                  <Button size="sm" variant="outline" className="flex-1 rounded-xl text-xs font-bold">Dispute</Button>
                </div>
              </div>
            ))}
          </div>
          <div className="mt-4 p-3 rounded-xl flex items-start gap-3" style={{ background: 'rgba(199,162,70,0.08)', border: '1px solid rgba(199,162,70,0.2)' }}>
        ...
        <div className="relative z-10 p-7 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
          <div>
            <span className="inline-block text-[10px] font-bold tracking-widest uppercase px-3 py-1 rounded-full mb-3"
              style={{ background: 'rgba(199,162,70,0.2)', color: '#C7A246' }}>Featured</span>
